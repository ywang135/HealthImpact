...
<script type="text/javascript" src="JS/jquery_methodology.js"></script>
	<div class="main_body">
		...
		<p>Drug scores are, roughly, Need*Access*Efficacy</p>
		...
		The country score would be 3 million DALYS averted.</p>
		...
		the Company Score would be 9 million DALYS averted.</p>
		<p>We also break down the scores so that it is possible to see the DALYS averted 
