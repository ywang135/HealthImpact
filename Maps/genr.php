...
<?php
	...
	echo "
	<map animation='10' showShadow='0' showBevel='0' showLabels='0' showMarkerLabels='1' fillColor='F1f1f1' borderColor='999999' baseFont='Verdana' baseFontSize='10' markerBorderColor='000000' markerBgColor='' markerRadius='0' legendPosition='bottom' useHoverColor='1' showMarkerToolTip='1' >
	<colorRange>
...
//<entity id='174' value='174' link='JavaScript:myJS('R', 174);' />
	...
	while($row = mysqli_fetch_array($result)){
		echo "<entity id='$row[5]' value='$row[4]' link=\"JavaScript:myJS('$row[0]','$row[1]','$row[2]','$row[3]','$row[4]','$row[6]');\" />";
    }
    mysqli_close($con);
    echo "
    	</data>
