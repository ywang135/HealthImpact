...
Daichii Sankyo has a total impact score of 115,978.61. All of its score came from treating TB. Daichii Sankyo produces two anti-TB treatments: Lfx and Ofx. Lfx is an essential drug for treating multiple drug resistant TB (MDR-TB). All three regimens for MDR-TB include Lfx. On the other hand, Ofx is included in the treatment regimen for extensively drug resistant TB (XDR-TB).</p><p>
...
Sanofi has a Total Impact Score of 20,180,459.12. Of that score, 67.29%, or 13,579,883.59, came from treating malaria and 32.71%, or 6,600,575.53, came from treating TB. Sanofi produces two widely-used first-line treatments against malaria, AS+AQ and AS+AP. Most of AS+AQ’s impact come from its average treatment coverage of 92.30%, which tops all other anti-malaria drugs. By the two anti-malaria drugs, Sanofi is responsible for 50.07% of the total DALYs alleviated that would have been lost to malaria in the world of 2010. Sanofi placed first in terms of total DALYs lost to malaria alleviated by any company.</p><p>
Sanofi also produces two anti-TB drugs, Eto and R. Eto is especially important in treating Multiple drug-resistant TB (MDR-TB) because it is included in all three anti-MDR-TB treatment regimens. R is also important because it is one of the drugs in the standard 6-month first-line regimen against TB. With its TB drugs, Sanofi helped to alleviate 24.97% of the DALYs that would have been lost to TB in the world of 2010. Sanofi placed second in terms of total DALYs lost to TB alleviated by any company.</p><p>
Although Sanofi’s drugs do not top other drugs companies make in every aspect that we measured, its consistently good performance in helping to alleviate the global burden of malaria and TB put it in first place in our index. </p>
  ...
  Shire Pharmaceuticals has a total impact score of 7,494,448.73. All of its score came from treating HIV/AIDS. Shire’s 3TC is the most-used first-line anti-HIV regimen. 3TC is included in 87.5% of first-line treatments against HIV of adults and 85.7% first-line treatments against HIV in children. 3TC is especially essential in treating children in Group A countries as part of a first-line regimen -- 8 out of 9 treatments for children in these countries include 3TC, which accounts for 98.5% of the treatment coverage. In 2010, 3TC helped to alleviate the most DALYs lost to HIV, 31.2% of all the DALYs alleviated in the world in 2010.</p><p>  
...
Boehringer Ingelheim Pharmaceuticals has a total impact score of 4,496,736.35. All of its score comes from treating HIV. Boehringer Ingelheim’s NVP is a first-line regimen treating HIV. Most of NVP’s score came from treating adults in Group A countries. Combined with other drugs, NVP accounts for 59.7% of adult first line treatment in Group A countries.</p><p>
In 2010, NVP helped to alleviate 4,496,736.35 DALYs lost to HIV in the world, which accounts for 19% of the total alleviated DALYs lost to HIV. In terms of total alleviated DALYs, NVP ranks second among all other anti-HIV drugs. Overall, Boehringer Ingelheim Pharmaceuticals ranks the sixth in our index.</p>
			</div>
			<div id="Pfizer" class="score_exp">
Pfizer Inc. has a total impact score of 13,209,904.58. All of its score came from treating TB. Pfizer’s four anti-TB drugs helped to alleviate more of the DALYs lost to TB than any other company in the world of 2010, which accounts for 49.97% of the total DALYs to TB averted in 2010. </p><p>
Pfizer’s E and Z are two of the four drugs in the standard 6-month first-line regimen against TB. Its Cs and PAS are essential drugs in treatments of multiple drug resistant TB (MDR-TB). All three MDR-TB treatment regimens include Cs and PAS.</p><p>
...
Bristol-Myers Squibb has a total impact score of 3,295,715.80. Of its score, 99.57%, or 3,281,667.21, came from treating HIV and 0.43%, or 14,048.60, came from treating TB.</p><p>
...
Hoffman-LaRoche has a total impact score of 6,587,721.05. All of its score came from treating TB. Hoffman-LaRoche’s sole anti-TB drug, H, served as one out of four drugs in the standard 6-month first-line regimen for drug susceptible TB. H performs the third best in alleviating DALYs lost to TB among all anti-TB drugs. It alone alleviated 6,587,721.05 DALYs in 2010—24.92% of the total DALYs alleviated that would have been lost to TB in the world of 2010. Hoffman-LaRoche is ranked fifth in our index.</p>
			</div> 			
			<div id="Gilead" class="score_exp">
Gilead Science has a total impact score of 2,006,033.09. All of its score came from treating HIV/AIDS. Gilead Science produces two drugs for treating HIV/AIDS: FTC and TDF. FTC serves as a regimen in treating adults in both Group A and B countries. Most of FTC’s score came from its inclusion in second-line treatment regimens for adults in Group A countries. FTC is included in 10.70% of second-line treatment regimens for adults in group A countries.</p><p>
Gilead Science’s second drug treating HIV/AIDS is TDF, which is included in regimens for adults in both Group A and Group B countries. TDF is also part of a second-line regimen to treat children in Group A countries, though this treatment regimen only accounts for 2% of second-line treatments for children in group A countries. Most of TDF’s score came from treating adults in Group B countries in second-line regimens. TDF is included in 6 out of 10 second-line treatments against HIV for adults in Group B countries. Combined with other regimens, TDF is part of 54.2% of second-line treatment regimens for adults in Group B countries.</p><p>
...
Abbot Laboratories has a total impact score of 338,621.58. All of its score came from treating HIV/AIDS. Abbot Laboratories receives credit for two anti-HIV drugs: LPV/r and half of the credit for ATV/r. LPV/r is included in regimens for treating adults and children in both Group A and Group B countries. Most of LPV/r’s score came from its inclusion in second-line treatment for adults in Group A countries. All second-line treatments of adults in Group A countries include LPV/r. LPV/r is most effective when combined with TDF and 3TC.</p><p>
ATV/r, the second of Abbot Laboratories’ treatments against HIV, is used only to treat adults in Group B countries. Most of ATV/r’s score came from treating these adults as a second-line regimen. ATV/r is included in 14.80% of second-line treatments for adults in Group B countries.</p><p>
...
Chongqing Tonghe Pharmaceutical Co. Ltd. Has a total impact score of 6,730.11. All of its score came from treating malaria. Chongqing Tonghe produces DHA-PPQ, which serves as a first-line treatment against malaria. Although DHA-PPQ ranks second in average treatment efficacy (97.50%), it has the lowest average treatment coverage (66.50%) among all anti-malaria treatments. Additionally, DHA-PPQ is only used a first-line drug for malaria in five countries. In 2010, Chongqing Tonghe’s DHA-PPQ helped to alleviate 0.02% of the total DALYs that would have been lost to malaria. Its total impact score ranks Chongqing Tonghe Pharmaceutical Co. Ltd. fourteenth in our index.</p>

			</div>
			<div id="Novartis" class="score_exp">
  Novartis has a total impact score of 13,555,766.77. Of that score, 99.85%, or 13,555,766.77, came from treating malaria and 0.15%, or 20,701.69, came from treating HIV/AIDS.</p><p> 
  Novartis’s malaria drug, AL, performs the best in almost every aspect among all anti-malaria drugs. It alleviated the second most—49.90% DALYs that would have been lost to malaria in the world of 2010. It is also the most used anti-malarial drug among countries. Out of 104 countries that specify a first line treatment for p. falciparum malaria, 53 used AL as the only, or a primary part of, their first-line drug treatments. Moreover, AL ranks as the second most effective anti-malaria drug, with an average efficacy of 98.10%.</p><p>
   Novartis also shares credit for an HIV drug, ATV/r, which accounts for the alleviation of 0.09% of the total avoided DALYs lost to HIV/AIDS. It is included in 2 out of 8 treatments in low-and-middle-income countries in Latin America.</p><p>
  Due to the impressive performance of AL, Novartis ranks second in our index.</p>
			</div>		
			<div id="Lilly" class="score_exp">
Eli Lilly has a total impact score of 2,082.75. All of its score came from treating TB. Eli Lilly’s anti-TB drug, Cm, serves to treat extensively drug resistant TB (XDR-TB). It helps to alleviate 0.008% of the total DALYs that would have been lost to TB in the world of 2010. Eli Lilly is ranked fourteenth in our index.</p>
			</div> 		
			<div id="Bayer" class="score_exp">
Bayer Healthcare has a total impact score of 1,562.06. All of its score came from treating TB. Bayer Healthcare’s anti-TB drug, Mfx, is part of the treatment regimen for extensively drug resistant TB (XDR-TB). In 2010, Mfx helped to alleviate 0.006% of the total DALYs that would have been lost to TB in the world. Its total impact score ranks Bayer Healthcare at the fifteenth place in our index.</p>

			</div> 
			<div id="Kyorin" class="score_exp">
Kyorin Pharmaceutical Co., Ltd has a total impact score of 1,562.06. All of its score came from treating TB. Kyorin’s anti-TB drug, Gfx is part of the treatment regimen for extensively drug resistant TB (XDR-TB). In 2010, Gfx helped to alleviate 0.006% of the total DALYs that would have been lost to TB in the world. Its total impact score ranks Kyorin Pharmaceutical Co., Ltd. sixteenth in our index.</p>
			</div>		
